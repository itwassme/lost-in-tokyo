...
const NavItem = ({ className, href, children, logo }) => (
  <li className={`mh2-ns f6 f4-l tc ${className}`}>
    <a className="black no-underline" href={href}>
      {logo ? (
        <img src="images/logo-black.svg" className="db center logo" />
      ) : (
        children
      )}
    </a>
  ...
  >
    <div>
      <h1 className="f4 f3-ns mt0 mb2 regular black normal lh-title">
        <a className="black link" href={link} target="_blank">
          {title}
        </a>
      </h1>
    ...
    return (
      ...
      >
        <div className="relative">
          {/* remember to pass down all of our props and state */}
